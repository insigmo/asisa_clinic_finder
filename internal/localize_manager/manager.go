...
var (
	rusMessages = messageMapper{
		...
		"/unknown_call":      `Извините\, неизвестная команда\. Попробуйте воспользоваться кнопками ниже`,
		"/clinics_not_found": `Извините\, но в базе не нашли клиник с данной специальностью\. Попробуйте найти смежную специальность\. Например не андролог\, а уролог`,
		"/clinic":            `Клиника\: `,
		"/address":           `Адрес\: `,
		"/phone":             `Телефон\: `,
	}
	esMessages = messageMapper{
		...
		"/unknown_call":      `Perdón\, comando desconocido\. Prueba a utilizar los botones que aparecen a continuación`,
		"/clinics_not_found": `Lo sentimos\, pero no hemos encontrado ninguna clínica con esa especialidad en nuestra base de datos\. Pruebe a buscar una especialidad relacionada\. Por ejemplo, en lugar de un andrólogo\, un urólogo`,
		"/clinic":            `Clínica\: `,
		"/address":           `Dirección\: `,
		"/phone":             `Teléfono\: `,
	}
	enMessages = messageMapper{
		...
		"/unknown_call":      `Sorry\, unknown command\. Try using the buttons below\.`,
		"/clinics_not_found": `Sorry\, but we couldn\'t find any clinics with that specialty in our database\. Try searching for a related specialty\. For example\, instead of an andrologist\, try a urologist`,
		"/address":           `Address\: `,
		"/phone":             `Phone\: `,
		"/clinic":            `Сlinic\: `,
	}
